...
public class HomeNetworkTask extends AsyncTask<Integer, String, Object> {

    final static String TAG = "HomeNetworkTask";
    ...
    //Constructor
    public HomeNetworkTask(Context context, String mAddr) {
    ...
    private void parser(String s){
        Log.v(TAG, "Parser()");
        try {
            Log.v(TAG, "color_select::::: " + s);
            // 배열이기 때문에 [] 이렇게 시작
            JSONObject jsonObject = new JSONObject(s);
            JSONArray jsonArray = new JSONArray(jsonObject.getString("color_select"));
            // object 가 읽어줌
